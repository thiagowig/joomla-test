	...
	<div class="error">
		...
		<div id="errorboxoutline">
			<div id="errorboxheader">
                ...
                <p class="errorboxmsg"><?php echo $this->error->getMessage(); ?></p>
            </div>
			...
			<p><strong><?php echo JText::_('JERROR_LAYOUT_PLEASE_TRY_ONE_OF_THE_FOLLOWING_PAGES'); ?></strong></p>
				...
				<ul>
                    ...
                    <li>
                        <a href="<?php echo $this->baseurl . '/index.php?option=com_finder'?>"><?php echo JText::_('JERROR_LAYOUT_SEARCH_PAGE')?></a>
                    </li>
				</ul>
